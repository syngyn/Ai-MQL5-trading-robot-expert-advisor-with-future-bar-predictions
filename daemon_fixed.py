...
from data_processing_with_indicators import create_features_for_live
            ...
            for file in files:
                try:
                    ...
                    resp = {
                        ...
                        "predicted_prices": pred_prices,  # Fixed: plural to match EA expectation
                        "predicted_class": pred_class,
                        "confidence_score": confidence,   # Fixed: added "_score" to match EA expectation
                        "buy_probability": buy_prob,      # Added: EA expects this field
                        "sell_probability": sell_prob     # Added: EA expects this field
                    }
